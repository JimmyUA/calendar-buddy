...
print(f"Config loaded. Using Firestore collections: {FS_COLLECTION_TOKENS}, {FS_COLLECTION_STATES}, {FS_COLLECTION_PREFS}, {FS_COLLECTION_PENDING_EVENTS}, {FS_COLLECTION_PENDING_DELETIONS}")
